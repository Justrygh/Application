...
public class csharp_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csharp_);
...
//                helper = fh.user.getProgress().get("cpp");
                ...
                helper = fh.user.getProgress().get("csharp").getTutorials();
                    ...
                    public void onClick(View v) {
                        Intent viewIntent =
                                new Intent("android.intent.action.VIEW",
                                        Uri.parse("https://www.w3schools.com/cs/cs_variables.asp"));
                ...
                vars_checkBox.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {/////////////TODO
                        ...
                        fh.user.getProgress().get("csharp").setTutorials(helper);
                ...
                strings.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent viewIntent =new Intent("android.intent.action.VIEW",
                                Uri.parse("https://www.w3schools.com/cs/cs_strings.asp"));
                        startActivity(viewIntent);
                        if (existsStr == false) {
                ...
                if_else.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent viewIntent =new Intent("android.intent.action.VIEW",
                                Uri.parse("https://www.w3schools.com/cs/cs_conditions.asp"));
                        startActivity(viewIntent);
                        if (existsElse == false) {
