...
public class Python_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_);
        ...
        */
        fh.readUser(new FirebaseHelper.OnGetDataListener() {
            ...
            public void onSuccess(Users usr) {
                ...
                Log.d("py ","     "+fh.user+" email  "+ fh.user.getEmail());

                helper = fh.user.getProgress().get("python").getTutorials();
                    ...
                    public void onClick(View v) {
                        Intent viewIntent =
                                new Intent("android.intent.action.VIEW",
                                        Uri.parse("https://www.w3schools.com/python/python_variables.asp"));
                ...
                vars_checkBox.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {/////////////TODO
                        ...
                        fh.user.getProgress().get("python").setTutorials(helper);
                ...
                strings.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent viewIntent =new Intent("android.intent.action.VIEW",
                                Uri.parse("https://www.w3schools.com/python/python_strings.asp"));
                        startActivity(viewIntent);
                        if (existsStr == false) {
                ...
                strings_checkBox.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        vars_checkBox.setEnabled(false);
                        Log.d("var check ", " prog = "+ fh.user.getProgress().get("python"));
                        fh.user.getProgress().get("python").setTutorials(helper);
                        fh.userUpdatemap(FirebaseAuth.getInstance().getUid(),fh.user);
                ...
                if_else.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent viewIntent =new Intent("android.intent.action.VIEW",
                                Uri.parse("https://www.w3schools.com/python/python_conditions.asp"));
                        startActivity(viewIntent);
                        if (existsElse == false) {
